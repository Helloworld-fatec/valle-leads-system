// src/components/dashboards/manager/ManagerConversionsByAttendantChart.tsx
import type { ConversionsByAttendantResponse } from "../../../services/dashboardService";

interface Props {
  data: ConversionsByAttendantResponse | null;
  loading: boolean;
}
...
export default function ManagerConversionsByAttendantChart({ data, loading }: Props) {
  const items = data?.conversionsByAttendant ?? [];
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: "#6B7280" }}>
            Fechamentos realizados no período
          </p>
        </div>
        <span
