// src/components/dashboards/general-manager/SalesByTeamChart.tsx
// Ranking de VENDAS por equipe (eventos 'won' na janela).
// Substitui o antigo TeamRankingChart (que contava leads convertidos).
import type { SalesByTeamResponse } from "../../../services/dashboardService";

interface Props {
  data: SalesByTeamResponse | null;
  loading: boolean;
}
...
export default function SalesByTeamChart({ data, loading }: Props) {
  const rows = data?.salesByTeam ?? [];
